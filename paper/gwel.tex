...
pixel resolution that three models spanning $8.6\times$ parameters and two
vision encoders agree on: a property of the corpus, measurable once.

Fifty-eight claims, including every negative result and the limits of the
...
\begin{enumerate}\itemsep2pt
  ...
  saturates at a pixel resolution that three models spanning $8.6\times$
  parameters and two vision encoders agree on, so the ceiling is a property of
  the corpus and can be measured once (\S\ref{sec:ladder},
  \S\ref{sec:singledomain}).
...
any stops holding; it currently checks fifty-eight, including the negative
...
three models with two vision encoders agree on.
